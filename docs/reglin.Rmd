...
> Importez les données `biometry` du package `BioDataScience1`. Utilisez la page d'aide pour en apprendre d'avantage sur ces données. Commentez ces données sur base de l'aide de la page d'aide en maximum 2 lignes.
